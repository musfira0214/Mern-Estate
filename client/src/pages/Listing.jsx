      ...
      <div>
        ...
        <div className='fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer' >
          ...
          className='text-slate-500'
           ...
           /*THIS IS THE function is used to copy the current URL)*/
        ...
        {/* if we selec offer box then it will run */}
            {
              listing.offer && (
        ...
        {/* ADD CONTACT LANDLORD FUNCTIONALITY this is not for owner anyother person */}
